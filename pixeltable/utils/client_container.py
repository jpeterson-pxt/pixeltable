...
class ClientContainer:
    ...
    Client acquisition via the get_client method is thread-safe
    ...
    clients: dict[StorageTarget, Any]  # Maps storage_target to client
    resources: dict[StorageTarget, Any]  # Maps storage_target to resource
    ...
    def get_client(self, soa: Optional[StorageObjectAddress]) -> Any:
        ...
        with self.client_lock:
            if soa.storage_target not in self.clients:
                ...
                assert soa.storage_target in self.clients
            return self.clients[soa.storage_target]
    ...
    def get_resource(self, soa: StorageObjectAddress) -> Any:
        ...
        with self.client_lock:
            ...
            return self.resources[soa.storage_target]
