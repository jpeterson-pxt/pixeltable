...
from pixeltable.utils.media_store import MediaStore, MediaStoreFile
...
class TestDestination:
    ...
    def test_dest_local_2(self, reset_db: None) -> None:
        ...
        assert len(r) == 2
        assert 3 * len(r) == MediaStore.count(t._id)
#        assert len(r) == MediaStoreFile(valid_dest_1).count(t._id)
#        assert len(r) == MediaStoreFile(valid_dest_2).count(t._id)
